<%-- 
    Document   : ReporteEventosReporgramadosMes
    Created on : 7 ene. 2024, 16:50:08
    Author     : nelki
--%>
...
<html>
    <head>
        ...
        <title>Reporte de Eventos Reporgramados por Mes</title>
    </head>
    <body>
        <%
            System.setProperty("java.awt.headless", "false");
            Conexion conexion = new Conexion();
            File reporfile = new File(application.getRealPath("reportes/EventosReprogramadosMes.jasper"));
