        ...
        <div class="container-fluid">
            ...
            <div style="padding: 10px 10px 10px 10px;" class="table-responsive">
                <table id="example" class="table table-responsive table-bordered navbarResponsive" width="100%" cellspacing="0" >
                    ...
                    <tbody id="tabla">
                        <% ArrayList<Eventos> listaEvt = daoEvt.selectAll();
                            int fila = 0;
                            for (Eventos registro : listaEvt) {
                        %>
                        <tr id="<%= fila%>">
                            <td class="row-data"><%= registro.getIdEvento()%></td>
                            <td class="row-data"><%= registro.getnEvento()%></td>
                            <td class="row-data"><%= registro.getDescripcion()%></td>
                            <%
                                if (registro.getCategoria().getCategoria().equals("A")) {
                            %>
                            <td class="row-data">TODA LA FAMILIA</td>
                            <%
                            } else if (registro.getCategoria().getCategoria().equals("B") == true) {
                            %>
                            <td class="row-data">MAYORES DE 14 AÑOS</td>
                            <%
                            } else if (registro.getCategoria().getCategoria().equals("C") == true) {
                            %>
                            <td class="row-data">MAYORES DE 18 AÑOS</td>
                            <%
                                }
                            %>
                            ...
                            <td>
                                <a class="btn btn-warning text-cente click" id="editar"  onclick="editarReg(<%= registro.getIdEvento()%>)">Editar</a>
                                <a class="btn btn-danger" id="idE" name="idE" onclick="confirmar(<%= registro.getIdEvento()%>)">Eliminar</a>
                            </td>
                        </tr>
                        <% fila++;
                            }%>
