 ...
 * @author karie
 */
public class BusquedaEventosDao {
    ...
    private static final String SELECT_EVENTOS_BY_CATEGORIA = "SELECT * FROM eventos WHERE n_evento like ?";

    public BusquedaEventosDao() {
        this.conexion = new Conexion();

    }

    public ArrayList<Eventos> getEventosCategoria(String n_evento) throws SQLException {
        ...
        try {
            ...
            this.ps.setString(1, n_evento);//el indice en el uno y el segundo lo que recibe por parametro
            ...
            Logger.getLogger(BusquedaEventosDao.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            cerrarConexiones();
        }
