<%-- 
    Document   : ReporteCapacidadTotalPorZonas_Establecimientos
    Created on : 9 ene. 2024, 21:51:58
    Author     : karie
--%>
...
<html>
    ...
    <body>
        <%
            ...
            File reporfile = new File(application.getRealPath("reportes/CapacidadTotalZonas.jasper"));
